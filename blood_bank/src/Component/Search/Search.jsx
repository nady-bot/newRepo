...
import searchItem from "../Search/search.png"
...
export default function Search() {
  return ( <>
   ...
   <div className={`"container" ${ style.container}`}>
     <div className="row w-50 mx-auto my-auto shadow bg-light">

     

  <div className="col-xl-12 text-center border border-1 border-danger rounded ">
