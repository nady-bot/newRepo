  ...
  return (
    ...
    <>
        <div className="text-intro w-75">
         <img className="w-25 h-25 px-4 m-2 rounded-2" src="img/bd.jpg" alt="donation"/>
        ...
        <div className="photo-slider text-center d-flex justify-content-center px-5">
         ...
         <div className="d-flex justify-content-between bg-danger px-4">
            <div className="p-1"> <img src="img/s1.jpg" className="w-100" alt="..."/> </div>
            <div className="p-1"> <img src="img/s2.jpg" className="w-100" alt="..."/> </div>
            <div className="p-1"> <img src="img/s3.jpg" className="w-100" alt="..."/> </div>
            <div className="p-1"> <img src="img/s4.jpg" className="w-100" alt="..."/> </div>
         </div>
